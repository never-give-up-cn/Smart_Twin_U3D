...
namespace Firesplash.GameDevAssets.SocketIO.Internal
{
    internal class SocketIOManager
    {
        ...
        {
            Debug.Log("1111111111111111111111111" + text);
        }
        internal static void LogWarning(string text)
        {
            Debug.LogWarning("[Socket.IO Implementation] 22222222222222222222" + text);
        }
        internal static void LogError(string text)
        {
            Debug.LogError("[Socket.IO Implementation] 3333333333333333333333" + text);
        }
